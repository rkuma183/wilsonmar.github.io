...
4. PROTIP: In your GitHub repository, create a "hooks" folder containing script files.

   Files in this folder are copied into the `.git/hooks` folder where Git and GitHub looks.

   There is a sample set of non-destructive hook files in the repo:
...
The repository has been configured to demo use of local Git hooks to run:
