...
0. Here we have some stranger's repository in GitHub which we have no rights to edit. 
   ...
   <a target="_blank" href="https://github.com/wilsonmar/git-utilities"><pre>https://github.com/wilsonmar/git-utilities</pre></a>
