...
0. A <strong>git branch</strong> command shows us the branches defined in the repository
   ...
   [ <a href="https://wilsonmar.github.io/git-shortcuts/#gb">Alternately, shortcut `gb`</a> ]
...
0. Make a change, then save the file.
   ...
   This command is used so often that Mac users create a [shortcut](/git-shortcuts/) in ~/.bash_profile:
...
0. The commit supplies a message describing changes, which applies to all files added. 
   ...
   * If a user name prefixed by an at sign (such as "@wilsonmar") is specified in the message, 
   ...
   [ <a href="https://wilsonmar.github.io/git-shortcuts#gas">gas "JIRA #1234"</a> ]<br />
   [ <a href="https://wilsonmar.github.io/git-shortcuts#gbs">gbs</a> (static "update" in message) ]
...
git log --graph
   ...
   * List a count of changes in each file in the commit (for example, abcdef1) with<br />
   ...
   [ <a href="https://wilsonmar.github.io/git-shortcuts#gl">gl</a> ]
