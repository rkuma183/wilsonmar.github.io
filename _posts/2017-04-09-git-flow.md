...
0. Request the pull from the upstream repo. For example: 
   ...
   <pre><strong>git request-pull v1.0 https://github.com/<em>upstream/project  master</em>
   </strong></pre>
...
<img width="650" alt="git-flow-20170526-650x369.png" src="https://cloud.githubusercontent.com/assets/300046/26503654/99d559ca-420f-11e7-8136-3e495188a8ad.png")
"><br />(Click here for full screen and printing)</a>
