...
To Delete the stack, first turn off <strong>Termination Protection</strong>:
...
and Michael show you:
   ...
   * <a target="_blank" href="https://app.pluralsight.com/library/courses/aws-automating-cloudformation">
   ...
   refers to a hypothetical admin ("called Adam") who creates a WordPress app using MySQL.
