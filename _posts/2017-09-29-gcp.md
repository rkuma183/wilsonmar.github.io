...
PROTIP: Use different browser programs to switch quickly among:

* Qwiklabs instructions in Brave browser (especially if you're using a different account)
* Cloud console (in Chrome) opened as an Incognito window. Alternatively, you can log out of all other Google / Gmail accounts before beginning the labs.
* Other instructions in Firefox
