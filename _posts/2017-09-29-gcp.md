...
1. <a target="_blank" href="https://cloud.google.com/free/docs/frequently-asked-questions">
   NOTE</a>: To create several accounts, use different emails, 
   <strong>each with a different credit card</strong>. Use a different browser
...
2. In the appropriate internet browser, apply for a Gmail address and use the same combination.
...
0. With the appropriate account and browser, configure at 
...
0. PROTIP: Bookmark the project URL.
...
0. CAUTION: Your bill can suddenly jump up to thousands of dollars a day, with no explanation.
...
<img alighn="right" alt="gcp-bigdata-menu-288x772-11619.png" src="https://user-images.githubusercontent.com/300046/37994303-5fc15acc-31ce-11e8-851c-60c80bdc8420.png">
