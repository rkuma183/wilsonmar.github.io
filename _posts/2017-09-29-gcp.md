...
Each exposed Kubernetes service (type == LoadBalancer) creates a forwarding rule.

The shutdown script doesn't remove the Forwarding rules created.
...
You'll be prompted for a region each time.
