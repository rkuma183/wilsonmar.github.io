...
0. At SonarQube server landing page (such as https://35.202.3.232)
...
0. switch back to the Bitnami screen to copy the command:
...
0. Save the command in a shell script (such as sonargo), then change the Dsonar.sources path.
0. chmod 555 sonargo
0. Run the sonargo script.
