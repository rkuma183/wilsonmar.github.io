...
Here is a <strong>hands-on</strong> introduction to learn the Google Compute Platform (GCP) and get certified as a Google Certified Professional (GCP).
...
![gcp-decision-tree](https://user-images.githubusercontent.com/300046/30033965-bd70b7a8-915b-11e7-9aba-9c2cbf5f62e8.png)
...
<a target="_blank" href="https://cloud.google.com/certification/guides/data-engineer/">Data Engineer</a>
...
on Coursera is a series of five one-week classes. 
...
4. Serverless Machine Learning with Tensorflow on Google Cloud Platform $99 USD
...
* "Pay as you go" rather than significant up-front purchase
* No software to install (and go stale)
* Google scale - 9 cloud regions in 27 zones. 90 Edge cache

But Google has the fastest fibre network, enabling high performance.
...
1. Click the icon.
   ...
   Has all tools and authentication pre-installed.

   A virtual machine with 5GB of persistent storage. Run df for sd1 5082480 K.
   But sessions have a 1 hour timeout.
...
Working with Google API Explorer to test RESTful API's
...
Offers the most control but also the most work (operational overhead).
...
Here, single-purpose <strong>functions</strong> are coded in JavaScript and executed in NodeJs
