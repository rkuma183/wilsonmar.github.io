...
excerpt: "Automate creation within MacOS of Windows 2016 server as VMware images used to make Vagrant images"
...
0. Add Windows apps using [Terraform](/terraform/) (or Ansible or PowerShell DSC)
