...
Vagrant has been around longer than Docker, so some consider it more "mature" and stable.

Vagrant is simpler to understand than Docker.

Individual Vagrant box images are Gigabytes larger than Docker "containers" because Vagrant box images contains the entire operating system whereas Docker separates out shared components. See my ["Docker setup tutorial"](/docker-setup/).

<a target="_blank" href="http://searchcloudapplications.techtarget.com/tip/Five-development-containers-to-consider-that-arent-Docker">Five alternatives to Docker</a>
