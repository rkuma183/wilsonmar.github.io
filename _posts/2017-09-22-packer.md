...
This tutorial contains hands-on <strong>step-by-step</strong> instructions that even "newbies" can follow to create a Windows 2016 server within a Mac laptop (the host machine). This is more of a deep dive than others, as it explains the intricacies for troubleshooting.
...
<a target="_blank" href="http://www.hurryupandwait.io/blog/creating-windows-base-images-for-virtualbox-and-hyper-v-using-packer-boxstarter-and-vagrant">Creating windows base images using Packer and Boxstarter /July 17, 2015</a>
by Matt Wrock (<a target="_blank" href="https://twitter.com/mwrockx/">@mwrockx</a>)
