...
0. <a href="#Deploy">Deploy script</a>
0. <a href="#ConfigMgmet">Server configuration management</a>
0. <a href="#NightlyBuilds">Nightly builts on deploy server</a>
0. <a href="#UnitTests">Unit tests</a>
0. <a href="#CodeRepos">Code repositories</a>
0. <a href="#SystemTests">Team-level system tests</a>
0. <a href="#CodeQuality">Code quality checks</a>
0. <a href="#AutoRuns">Automated runs</a>
...
0. <a href="#AcceptanceTests">User-level acceptance tests</a>
...
## 6. Nightly builds on deploy server
...
## 14. Predictions based on previous metric values
...
## 15. Metrics dashboard and retention
...
## 16. System-level integration tests
...
## 17. User-level acceptance tests
...
## 20. Continuous Deployment to production
