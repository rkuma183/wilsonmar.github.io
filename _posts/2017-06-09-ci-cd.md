...
1. <a href="#PackageManagers">Package managers</a>
2. <a href="#SourceRepositories">Source repositories</a>
3. <a href="#BinaryRepositories">Binary repositories</a>
4. <a href="#Deploy">Deploy script</a>
5. <a href="#ConfigMgmet">Server configuration management</a>
6. <a href="#NightlyBuilds">Nightly builts on deploy server</a>
7. <a href="#UnitTests">Unit tests</a>
8. <a href="#CodeRepos">Code repositories</a>
9. <a href="#SystemTests">Team-level system tests</a>
10. <a href="#CodeQuality">Code quality checks</a>
11. <a href="#AutoRuns">Automated runs</a>
12. <a href="#CodeCoverage">Code Coverage</a>
13. <a href="#Alerts">Alerts</a>
14. <a href="#Metrics">Predictions based on previous metric values</a>
15. <a href="#Dashboard">Metrics dashboard and retention</a>
16. <a href="#IntegrationTests">System level integration tests</a>
17. <a href="#AcceptanceTests">User-level acceptance tests</a>
18. <a href="#ServerMon">Server monitoring</a>
19. <a href="#RegressionTests">Regression testing</a>
20. <a href="#CDtoProd">Continuous deployment to production</a>
21. <a href="#Acceleration">Change aceleration</a>
...
## 1. Package managers
   ...
   own manager: <strong>apt-get</strong> for Red Hat and Ubuntu, 
   <strong>yum</strong> for Debian, 
   <strong>Homebrew</strong> for MacOS, 
   which has a command such as:

   <pre><strong>brew install make
   </strong></pre>

   For Windows machines, there is NuGet. 
   <a target="_blank" href="https://chocolatey.org/">
   Chocolatey.org</a> exposes NuGet packages
   with a simple command like Homebrew does:

   <pre><strong>choco install make
   </strong></pre>

   Package managers automatically update ALL
...
## 2. Source repositories</a>
   ...
   all organizations to store server configuration code using the
   same Git mechanism as app developers. 

   All this is so human-readable code is
...
## 10. Code Coverage
   ...
   There are programs such as SonarQube
