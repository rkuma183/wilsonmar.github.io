...
## 3. Nightly builds on deploy server
...
## 11. Alerts based on previous metric values
...
## 12. Metrics dashboard and retention
...
## 14. User-level acceptance tests
