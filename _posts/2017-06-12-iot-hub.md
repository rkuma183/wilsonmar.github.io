...
<div itemscope itemtype="http://schema.org/Article">
  <h1 itemprop="name">IoT Gateway</h1>
  <p itemprop="description">IoT Gateway.</p>
...
0. Get the repo described in :
   ...
   * TimerTrigger - Execute cleanup or other batch tasks on a predefined schedule.
   ...
   https://courses.edx.org/courses/course-v1:Microsoft+DEV225x+2T2017/courseware/bd777be2a03644118d8729cfb0795c6a/f1655c556d4a40488483fb617a7f4194/?child=first
