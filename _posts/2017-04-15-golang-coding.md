...
0. Pull down from GitHub:
   ...
   <pre><strong>git clone https://github.com/wilsonmar/golang-samples
   </strong></pre>
...
0. Format source code according to Go coding standards:
   ...
   See <a target="_blank" href="https://golang.org/cmd/gofmt/">
...
0. A line at the top of the file enables it to be optionally run as a shell sript:
   ...
   <pre><strong>./hello-temp.go
   </strong></pre>

0. Run it as a program:

   <pre><strong>go run hello-time.go
   </strong></pre>
...
0. Run the executable on Linux or mac:
   ...
   <pre><strong>./hello-time
   </strong></pre>

   Alternately, on Windows, run the executable:

   <pre><strong>hello-time.exe
   </strong></pre>
