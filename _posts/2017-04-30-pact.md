...
1. Pact functions and methods are added to the top of test code after importing or including the Pact framework, which has been  <a target="_blank" href="https://github.com/pact-foundation/README">implemented in multiple programming languages</a> (through several organizations):
