...
excerpt: "Write Gherkin to drive tests for behavior-driven and test-driven development"
tags: [API, devsecops]
...
The cucumber server is started using a command such as:

   <pre>
cucumber -f pretty -f html -o report.html
   </pre>

TODO: An example of cucumber's HTML output:
...
Gherkin code can be editted with any text editor.
