...
npm WARN bin No license field.
   ...
   BLAH: Here is where I'm stuck.



## RECON text formatting helpers #

0. To enable the Sublime Text editor to better highlight RECON-format text,
   SWIM created a file at 
