...
0. Extract the swimjs client logic from the swimit corporate library using [Homebrew](/macos-homebrew/) tap:
   ...
   BLAH: "swimit" was not found in http://brewformulas.org/ nor
...
0. Install the swimjs logic using [Homebrew](/macos-homebrew/)
   ...
   NOTE: "swimjs" was not found in http://brewformulas.org/ nor
   http://braumeister.org/
