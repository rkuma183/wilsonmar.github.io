...
This sample program has functionality common to most other programs.
...
0. Open Chrome Developer Tools in a new window by selecting the "hamburger" icon at the upper right,
