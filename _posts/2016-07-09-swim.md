...
0. Install the swimjs logic using [Homebrew](/macos-homebrew/)

   As described in https://github.com/swimit/swimjs

   <tt><strong>
   brew tap swimit/swim<br />
   brew install swimjs
   </strong></tt>

   NOTE: "swimjs" was note found in http://brewformulas.org/ nor
