...
0. The home page for Xamarin is <a target="_blank" href="https://xamarin.com/">
   ...
   * $0 for <a href="#HockeyApp">deployment and crash monitoring</a>
   ...
   Aside from differences in test cost, 
   note the Perfecto cloud offers a <strong>private</strong> cloud.

   More importantly, alternative test clouds may have a wider choice of devices and, 
   perhaps most importantly, have 
   <strong>new devices earlier</strong> than other clouds.
