...
This article currently contains my notes about installing and using Xamarin.
...
0. While you wait visit other pages to
   ...
   * Xamarin Test Cloud 
   ...
   Xamarin Test Cloud tests support Ruby with the Calabash framework, 
   C# with Xamarin.UITest, and Java via the Appium framework. 
