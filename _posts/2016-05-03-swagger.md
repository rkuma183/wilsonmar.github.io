...
Having specs listed and published in public galleries of APIs
can boost recognition and community-building for APIs.

There are several competing API specification formats (such as RAML and WADL),
but <strong>Swagger</strong> seems to be the most popular at this time, so many have written programs for it,
such that
...
The Swagger spec doesn’t support some features:
