...
## Sample JHipster apps
   ...
   Monitoring
   by Josh Long at Springat Pivotal
...
0. <a target="_blank" href="https://great-big-example-application.herokuapp.com/#/">
   ...
   The screen above shows the app after clicking Account and selecting an option:
   ...
   One can also sign-in using admin/admin for the Admin menu options:
