...
<a target="_blank" href="https://jhipster.tech">https://jhipster.tech</a> is the home page for JHipster.
...
0. Install the latest Java Development Kit (JDK).
   ...
   Through collaboration by <a target="_blank" href="https://github.com/jhipster/generator-jhipster/">nearly 400 contributors on GitHub</a>, and Dubois' consulting company, the JHipster generator is reaching fruition. 
   ...
   But there are two options to make use of it:
   ...
   A) Fork, then clone or download the generator into your local folder to run its command line program (`yo hipster`) to specify options used while creating application code. Instructions <a href="#LocalGen">here</a>.

   B) In 2017 a JHipster cloud website was created to provide a form to select <a href="#GeneratorDefault">default options</a> the website uses to create application code. The steps for that:
...
0. Scroll down past all default selections.
   ...
   * H2 (with disk-based persistence) for dev detabase
...
https://www.youtube.com/watch?v=dzdjP3CPOCs&t=276s
