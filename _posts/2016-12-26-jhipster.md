...
There are two stages to generating an application using JHipster.

The first stage is to use the JHipster generator to create a base set of files based on unique configuration settings. The second stage is to download the various node module libraries. Let's do the first stage first.
