...
it's just now become more useful, complete, and thus important over time.

JHipster (at <a target="_blank" href="https://jhipster.github.io/">
JHipster.github.io</a>) should really be called a <strong>project generator</strong> and not just a code generator because it creates code for the entire application and DevOps stacks
...
What is generated will probably not be exactly what you want. But it gets you going, making use of all the many components of the front-end, back-end, and DevOps tool stacks.

> The magic of JHipster's approach is that a community of developers work on integrations for everyone. This makes upgrades much easier than hacking them every time.
