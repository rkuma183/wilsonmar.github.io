...
JHipster should really be called a <strong>project generator</strong> and not just a code generator because it creates code for the entire application and DevOps stack:
...
Add another entity and JHipster builds a form screen to manage the data:
   ...
   * Angular 7 on 2018-09
   ...
   NOTE: All Google applications use the Angular version equal to the current GitHub’s master branch of the Angular repository. 
...
What is generated will probably not be exactly what you want. But it gets you started with a website that has, for one, a full-featured user registration screen:
