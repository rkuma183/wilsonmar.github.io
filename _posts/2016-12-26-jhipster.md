...
0. View the sample app generated from default settings:
   ...
   PROTIP: The landing page of this website lists source demos and guides.

0. View the sample app online URL from the JHipster book:
