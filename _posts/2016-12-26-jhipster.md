...
0. <a href="#AdminMenu">Administrator back-end functionality</a> (Monitoring, Logging, etc.).

0. <a href="#LogoConfig">Customize images and text displayed</a>, then <a href="#BrowserSync">Browser Sync</a>.
...
0. <a href="#AddEntities">Add Entities</a> into the database.
...
## Generate Custom App Code
   ...
   A) Fork, then clone or download it into your local folder and run its command line program to create application code based on specifications. Instructions <a href="#LocalGen">here</a>.

   B) Use a JHipster cloud website that provides a form to select <a href="#GeneratorDefault">default specifications</a> which the website uses to create the application. We're doing this first:
...
0. Start the back-end Java server:
   ...
   The response in the command line console concludes with something like this:
...
<hr />
   ...
   ## Administrator back-end functionality
...
0. Click on <strong>Configuration</strong>.

   Highlight all text on the page. QUESTION: why are properties hidden using a white font?

   ![jhipster-admin-config-white-650x145-26577](https://user-images.githubusercontent.com/300046/30246573-9d14c10c-95bb-11e7-9ee5-a39051ca2933.jpg)
...
spring:
   ...
   ### About Spring UI tech

   NOTE: "Spring" refers to the Java Spring framework from Pivotal.
   ...
   The JHipster website is based on source at<br />
   ...
   provides ES6 polyfill.
   https://gitter.im/zloirock/core-js
...
0. Click the <strong>Entities</strong> menu text.

   Note there are no entities defined yet.
