...
JHipster should really be called a <strong>project generator</strong> and not just a code generator because it creates code for the entire application and DevOps stacks
based on a <a target="_blank" href="https://en.wikipedia.org/wiki/Entity%E2%80%93relationship_model">entity data model</a> that talks about business-level objects, not technical entities. 
...
To build and manage models, JHipster has created a <a target="_blank" href="https://jhipster.github.io/jdl-studio/">
JDL Studio</a>.
...
What is generated will probably not be exactly what you want. But it gets you started with a site that has <a href="#UserRegistration">user registration</a>, logging, etc. 
...
Perhaps more importantly, also generated is a default implementation of back-end and DevOps code that automatically scales in a cloud.
