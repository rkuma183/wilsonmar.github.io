...
This article provides a hands-on introduction on how to use JHipster to generate a complete set of code using the hippest (lastest, shinest) tools and utilities, running in a cloud of your choice.
...
Through collaboration on GitHub, the concept is reaching fruition in JHipster (at <a target="_blank" href="https://jhipster.github.io/">JHipster.github.io</a>). The first commit to 
<a target="_blank" href="https://github.com/jhipster/">
https://github.com/jhipster</a> (<a target="_blank" href="https://twitter.com/java_hipster">@java_hipster</a>) 
by <a href="#JulienDubois">Julien Dubois</a> was on October 21, 2013.
...
JHipster should really be called a <strong>project generator</strong> and not just a code generator because it creates code for the entire application and DevOps stack:
   ...
   SPA (Single Page Application) Angular UIs communicate via HTTP/2 WebSockets to back-end Java Spring microservices. BTW, "AngularJs" refers to the Angular1.x framework at
...
The UI is based on a <a target="_blank" href="https://en.wikipedia.org/wiki/Entity%E2%80%93relationship_model">"entity data model"</a> that talks about business-level objects, not technical entities. 
