...
There are several ways JHipster can generate an application.

![jhipster-gen-flow-650x291-101764](https://user-images.githubusercontent.com/300046/30212392-eeeaeb92-9461-11e7-987c-ad7feb58d823.jpg)

A) Download JHipster-generate and run generator.

B) Run generator in the cloud to a public repo under your GitHub account. Described below:
...
0. In a Terminal, create or navigate to a folder where this command creates a folder, such as a folder containing your account name.
   ...
   The download consists of 1,128,887 bytes (2.1 MB on disk) for 398 items
