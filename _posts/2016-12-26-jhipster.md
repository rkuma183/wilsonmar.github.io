...
JHipster, at <a target="_blank" href="https://jhipster.tech">https://jhipster.tech</a>, should really be called a <strong>project generator</strong> (and not just a code generator) because it creates code for the entire application project and also the whole <strong>DevOps stack</strong>:
...
0. From the top menu click "Administrator" to select "Database":
   ...
   NOTE: This is for the default H2 database chosen during <a href="#GeneratorDefault">JHipster Generator default selections</a>.
...
0. Click "Entities" at the top menu to notice that none are defined by default.
...
## DevOps Back-end
   ...
   coded with Spring Boot <a target="_blank" href="https://jhipster.github.io/microservices-architecture">"microservice architecture"</a> that runs <a target="_blank" href="#NetflixOSS">Netflix’s OSS (Open Source Software)</a> with Docker containers.
