...
JHipster should really be called a <strong>project generator</strong> and not just a code generator because it creates code for the entire application and DevOps stack:
   ...
   The front-end code uses a <a target="_blak" href="https://jhipster.github.io/microservices-architecture">"microservice architecture"</a> that makes use of Netflix’s OSS (Open Source Software).
