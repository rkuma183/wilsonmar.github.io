...
This article provides a hands-on introduction to generate a complete set of code using the hippest (lastest, shinest) DevOps tools and utilities, running first locally, then publically in a cloud of your choice.
...
JHipster (<a target="_blank" href="https://twitter.com/java_hipster">@java_hipster</a>) at <a target="_blank" href="https://jhipster.tech">https://jhipster.tech</a>

<a target="_blank" title="jhipster-tech-1419x748.png" href="https://user-images.githubusercontent.com/300046/30241644-a9152e82-9544-11e7-9bac-d7fc923d8868.jpg"><img alt="jhipster-tech-650x343-85002.jpg" src="https://user-images.githubusercontent.com/300046/30241639-8928ec76-9544-11e7-931e-aeec1a948a21.jpg"><p align="right"><small>Click to pop up larger image</small></p></a>

This tour includes:

1. <a href="#GenCode">Generate Code using JHipster</a>.
0. <a href="#Download">Download the various node module libraries</a>.
0. <a href="#RunServer">Run the web server locally</a>.

0. <a href="#AdminMenu">Administrator back-end functionality</a> (Monitoring, Logging).
0. <a href="#LogoConfig">Customize Logo and Text Displayed</a>, then <a href="#BrowserSync">Browser Sync</a>.
0. <a href="#ReBuild">Re-build app</a>

0. <a href="#UserEmail">Customize Email server for User Registration</a>
0. <a href="#CustomApps">Apps built upon JHipster</a>
0. <a href="#AddOns">Add Add-ons</a>.

0. Upload to the Master branch in GitHub/GitLab.
0. Run the web server publicly in production.
...
A) Fork, then clone or download it into your local folder and run its command line program to create application code based on specifications. 
...
[INFO] ------------------------------------------------------------------------
   ...
   <a target="_blank" href="https://user-images.githubusercontent.com/300046/30241702-d6d1d45a-9545-11e7-9fc9-450b06a2df12.jpg"><img alt="hipster-jococo-rpt-1156 494-484782" src="https://user-images.githubusercontent.com/300046/30241702-d6d1d45a-9545-11e7-9fc9-450b06a2df12.jpg"><p align="right"><small>Click to pop up larger image</small></p></a>
...
0. In a browser, view the web application generated:
   ...
   PROTIP: The wonder of JHipster generator is it generates a rather complete set of back-end functionality.

0. At the upper-right corner, click to expand <strong>Account</strong> to select Register: 
...
0. Sign-in using the built-in `admin` user and `admin` password for the Admin menu options:
   ...
   Generated is a default implementation of back-end functionality:
   ...
   Installation of JVM monitoring agents is automatically done, which enables a UI such as this:
...
0. To change the "This is your footer" text at the lower left corner of the JHipster default landing screen.
...
0. Click the <strong>Account</strong> link at the upper-right corner.
...
0. Use a text editor to edit file `application-dev.yml` within folder `src/main/resources/config` to change:
   ...
   CAUTION: This approach exposes credentials to the email server. Can it use Hashicorp Vault to manage secrets?
...
xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx
   ...
   ## Change Entity Diagram

JHipster generates code from an <a target="_blank" href="https://en.wikipedia.org/wiki/Entity%E2%80%93relationship_model">"entity data model"</a> that talks about business-level objects, not technical entities. 
