...
0. View the "Great Big Example" app running all the time in the Heroku cloud at:
   ...
   It was created based on JHipster by <a target="_blank" href="https://github.com/dancancro">Dan Cancro</a> has Entities and Features:
