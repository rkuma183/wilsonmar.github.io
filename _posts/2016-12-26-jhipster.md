...
[Generation of programming code](/code-generation/) is not new. It's just now become more useful, complete, and thus important. Traditionally, crafting everything by hand seemed more economical. Creating a generator is an investment that requires longer-term thinking. But many have realized that the complexity of all the code needed requires a community approach. 

The magic of JHipster's approach is that a community of developers work on integrations for everyone else. This makes upgrades much easier than hacking them every time.
...
Add a object and JHipster includes
...
What is generated will probably not be exactly what you want. But it gets you started with a site that has <a href="#UserRegistration">user registration</a>, logging, etc. Perhaps more importantly, also generated is a default implementation of back-end and DevOps code that automatically scales in a cloud.
