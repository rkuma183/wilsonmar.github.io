...
What is leading-edge about the UI is that generation is based on a <a target="_blank" href="https://en.wikipedia.org/wiki/Entity%E2%80%93relationship_model">"entity data model"</a> that talks about business-level objects, not technical entities. 
