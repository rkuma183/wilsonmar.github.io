...
0. <a href="#GitHubDownload">Download from GitHub</a> the various node module libraries</a>.
...
0. Scroll down past all default selections.
   ...
   * JUnit, Karma, Gatling, Cucumber, Protractor
   ...
   NOTE: These selections are stored in <a href="#JHipsterInfo">file `.yo-rc.json`</a>.
