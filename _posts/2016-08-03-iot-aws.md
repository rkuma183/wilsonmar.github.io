...
Amazon provides perhaps the lowest-cost IoT device. They sell two different configurations: 
...
The customizable's price seems steep compared with 
<a target="_blank" href="https://www.amazon.com/Amazon-JK29LP-Trojan-Dash-Button/dp/B01C3JBA7M/">
...
1. Be on a wi-fi network that is always on.
2. In Play Store or Apple Store, search for <strong>AWS BTN Dev</strong>.
3. Click "Login" and provide your email and password.
4. Notice "Oregon (us-west-2)" at the bottom of the page. Tap the region to select <a href="#Region">other regions support the button</a>.
...
12. If you don't remember the password,
13. Type the password (such as "6493AN4F"). Remember to use upper case.
14. If you need to, return to the previous screen by swiping left on the bottom of your iPhoneX.
15. Click Join. The light on the thing should flash when your Wi-Fi starts with "Button ConfigureMe".<br />
    But if you took took long, cancel and start over.
