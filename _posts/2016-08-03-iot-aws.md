...
This teardown</a> found that buttons contain an Energizer brand AAA Lithium battery.
...
1. In Play Store or Apple Store, search for <strong>AWS BTN Dev</strong>.
2. Click "Login" and provide your email and password.
3. Notice "Oregon (us-west-2)" at the bottom of the page. <a href="#Region">Other regions support the button</a>.
4. Click "Setup AWS IoT Button".
5. Click "Agree & get started".
6. Click "Tap here to scan DSN barcode".

* Pressing the AWS IoT button for 15 seconds until a blue blinking light appears resets the configuration.

7. Write down the password (such as "63434888").
8. Click "Copy password and go to settings" to be sent to the Settings page.
9. Click "Wi-Fi" and select "Amazon ConfigureMe" while the blue light appears.
   The light should now flash.
...
10. Swipe right on the bottom of your iPhoneX to return to the Configure screen.
