...
3. If you have not already, create a new AWS account root account for master billing.
3. Provide your master account email and password to sign in.
3. Click Services and type in IAM to Manager User Access.
3. On the website, create an IAM account specifically for use on the IoT device.
