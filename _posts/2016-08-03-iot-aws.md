...
0. Login to the Console at <br />
   https://console.aws.amazon.com/iot/home?region=us-east-1#/home

0. Select "N. Virginia" 
   because it's the only region supporting Lambda at this time.
...
0. Type in Device Serial Number (DSN) 
   <strong>without spaces</strong> from the back of the thing.
...
0. Scroll down to "Role*" and select "Choose an existing role"

   ERROR: This is where I got stuck.

0. Select "lambda_basic_execution". ???
...
https://docs.aws.amazon.com/console/iot/quickstart<br />
list components

0. https://console.aws.amazon.com/iot/home?region=us-east-1#/tutorial
