...
this guy</a> shows he re-purposed the Dash by intercepting its ARP request.
...
WARNING: The button uses <strong>wi-fi</strong> (2.4 Ghz) so its battery may not last as long as
other buttons using Bluetooth Low Energy data transmission.
But wi-fi has a wider (stronger) signal than Bluetooth.
...
This teardown</a> found inside a Dash button an Energizer brand AAA Lithium battery.
...
* Honey I'm home! <a target="_blank" href="https://www.hackster.io/reanimationxp/amazon-re-invent-dash-button-aws-ifttt-infinibutton-daaf5d?ref=part&ref_id=13747&offset=0">
   ...
   though which you can specify all manner of actions (send voicemail, etc.).
...
* Switch a Philips Hue light bulb on and off (party mode)
...
0. PROTIP: Know the password to your network's WiFi because Button setup needs it.
   ...
   <amp-img width="650" height="353" alt="aws-iot-setup-flow-v01-650x353-i11.jpg" src="https://cloud.githubusercontent.com/assets/14143059/17655258/2017ee44-6269-11e6-9f0d-b494464d50b2.jpg"></amp-img>
...
0. Click "Connect AWS IoT Button" for the AWS Lambda console at<br />
...
0. Navigate to your computer's Network settings page, Open Network Preferences, 
   ...
   <strong>Button ConfigureMe - 977</stong>
...
0. Click "Browse" next to Certificate and select the "...-certificate.pem.crt" file you just downloaded above.

0. Click "Browse" next to Private Key and select the "...-private.pem.key" file you just downloaded above.

0. Copy the <strong>Endpoint Subdomain</strong> from ???
0. Copy the <strong>Endpoint Region</strong> from ???

0. Check the box to agree to the terms and conditions.
   This should result in an endpoint generated, such as:

   <tt>a1ysu30jyr2f8t.iot.us-east-1.amazonaws.com</tt>
...
0. If the black part of the screen isn't visible, click the "?" on the right edge to expand it.
...
0. Create your IFTTT Maker Channel at<br />
   ...
   https://ifttt.com/maker</a>

   Create an account if necessary. 

0. Obtain your IFTTT Maker Channel Key
...
0. Type in Rule Name: "AWS IoT to IFTT".
