...
The central team also maintains off-shore expertise to provide scripting expertise
...
2. **Where can programming "hang" the system?**
   ...
   This is done by programs that automate how real people type on keyboards and click mice.
