...
1. Invoke the neo4j executable without any parameters to obtain a help response:
...
4. Edit the configuration file using "subl" or substituting "vi" or your text editor:
...
1. Click "Monitor" and press Enter to invoke its command <tt><strong>:sysinfo</strong></tt>
