...
10. Click on the top command entry field to the right of the dollar sign.

    <pre><a target="_blank" href="https://user-images.githubusercontent.com/300046/34472118-7f27bd18-ef28-11e7-8247-9277afcdcb32.png"><img width="603" alt="neo4j-commands-1206x800" src="https://user-images.githubusercontent.com/300046/34472118-7f27bd18-ef28-11e7-8247-9277afcdcb32.png"></a></pre>
...
10. Click the gear icon near the lower-left corner among menu icons.

   <pre><a target="_blank" href="https://user-images.githubusercontent.com/300046/34465151-4dc9ded8-ee5e-11e7-87d8-e3a92d459795.png"><img width="1174" alt="neo4j-console" src="https://user-images.githubusercontent.com/300046/34465151-4dc9ded8-ee5e-11e7-87d8-e3a92d459795.png"><br /><small>Click image for larger image pop-up.</small></a></pre>

11. Click Theme Dark.
12. Click the icon again to dismiss menu contents. (it's a toggle)
...
1. Type command <tt><strong>:sysinfo</strong></tt>

   <img width="765" alt="neo4j-sysinfo-1530x596" src="https://user-images.githubusercontent.com/300046/34470659-576f0598-ef04-11e7-8016-e5d76b352895.png">

2. Query logging must be enabled by setting the parameter to:
...
3. There are <a target="_blank" href="https://neo4j.com/docs/operations-manual/current/monitoring/logging/query-logging/">additional logging parameters</a> that are false by default:
...
13. Click the icon that looks like a book (previously this was an i icon for information).
14. Click "Getting Started".
...
15. To submit the command, press Enter or click the arrow icon at the upper-right corner.
...
16. Scroll down the page to see that the new response is added above the previous frame, as in a stack as a stream.
17. Click the gray X to dismiss a content frame.
18. Click "Operations Manual" under Useful Resources to pop up a new browser tab to the version installed: https://neo4j.com/docs/operations-manual/3.2/
...
1. Click "Write Code" and press Enter to invoke <strong>:play write code</strong>.
...
5. BLAH: Drag and drop items to arrange the graph to your asthetic taste.
   ...
   <img width="838" alt="neo4j-movie-graph-1676x702-144758" src="https://user-images.githubusercontent.com/300046/34470717-c7b80a1a-ef05-11e7-9f9d-2fa35ee496e2.png">
...
Cypher keywords ENDS, WITH, and CONTAINS are, as of v3, index-backed.
...
3. Sign up for http://neo4j.com/slack

4. Join https://groups.google.com/forum/#!forum/neo4j

5. Visit a Meetup group

6. Read https://neo4j.com/blog/

7. Tweet to https://twitter.com/neo4j - #GraphViz #Neo4j #GraphDatabases

8. Subcribe to <a target="_blank" href="https://www.youtube.com/channel/UCvze3hU6OZBkB1vkhH2lH9Q">Neo4j's YouTube channel</a> and view videos.
